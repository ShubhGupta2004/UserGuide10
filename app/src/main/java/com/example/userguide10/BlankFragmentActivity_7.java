 ...
 */
public class BlankFragmentActivity_7 extends Fragment {
    ...
    public static BlankFragmentActivity_7 newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        BlankFragmentActivity_7 fragment = new BlankFragmentActivity_7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_blank_activity_7, container, false);
        TextView textView = (TextView) view.findViewById(R.id.text_fragment7);
        afterLoginActivity act = (afterLoginActivity) getActivity();
        assert act != null;
        String text = "Landmark ";
        textView.setText(text);
        url1="https://api.foursquare.com/v3/places/search?ll="+act.getLatitudeText()+"%2C"+act.getLongitudeText()+"&radius=100000&categories=19000&sort=DISTANCE&limit=39";
        list = (GridView) view.findViewById(R.id.list_fragment7);
